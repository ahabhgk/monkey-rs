...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _pkg_monkey_rs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../pkg/monkey_rs */ \"../pkg/monkey_rs.js\");\n\n\nconst $ = (selectors) => document.querySelector(selectors)\n\nconst $input = $('.input')\nconst $output = $('.output')\nconst $run = $('.run')\n\n$run.addEventListener('click', e => {\n  const code = $input.value\n  const output = _pkg_monkey_rs__WEBPACK_IMPORTED_MODULE_0__[\"run\"](code)\n  $output.textContent = output\n})\n\n\n//# sourceURL=webpack:///./index.js?");
